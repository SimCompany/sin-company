...
export default function FormElement() {
  ...
  return (
    <Flex as='form' w='100%' flexDirection='column' bgColor='Green.300' p='8'>
      <Box>
        <Text textAlign='center' color='white' fontSize='35' fontWeight='bold'>Gostaria de receber uma proposta para o seu negócio?</Text>
      ...
      <Box display='grid' gridTemplateColumns='1fr 1fr' gridColumnGap='4' gridRowGap='4'>
      ...
      <Textarea mt='4' focusBorderColor="Green.800" variant='outline' placeholder="Conte um pouco sobre sua procura, iremos preparar um orçamento especial para você!" bgColor='white' />
